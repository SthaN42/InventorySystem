...
void UInv_InventoryComponent::TryAddItem(UInv_ItemComponent* ItemComponent)
{
	...
	{
		// This item type doesn't exist in the inventory. Create a new one and update all pertinent data.
...
void UInv_InventoryComponent::SpawnDroppedItem(UInv_InventoryItem* Item, int32 StackCount) const
{
	...
	RotatedForward = RotatedForward.RotateAngleAxis(FMath::FRandRange(DropSpawnAngleMin, DropSpawnAngleMax), RotatedForward.UpVector);
	...
	SpawnLocation.Z += DropRelativeSpawnElevation;
